# Проект архивирован/приостановлен за ненадобностью
Программы на подобии GoodbyeDPI и Zapret более неспособны поддерживать стабильных обход блокировок интернета, во многих регионах страны не функционируют вовсе.
